...
Hello folks, I’m planning to initiate a series of (long running) ML/Deep Learning sessions here in Bangalore office twice a week, to start with. My preferred timing is Tuesday and Thursday, 10:15 - 11:15 am, as mornings work out best for me. Below are the high level topics that I intend to cover. It’ll probably take around 4 - 6 months to complete all of these materials in sufficient depth. I’ll be adding pdf(s) and jupyter notebook(s) for each logical section, as we go along.
